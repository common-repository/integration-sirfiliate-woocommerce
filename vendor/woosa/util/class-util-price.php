      ...
      if ( is_numeric($this->price) && $this->price > 0 ) {
         ...
         switch ($mode) {
            ...
            case '.75':
               ...
               $number     = (float) substr($this->price, 0, strrpos($this->price, '.'));
               $number_dcm = (float) substr($this->price, strrpos($this->price, '.')+1);
               $number_dcm = ceil( $number_dcm / 5 ) * 5;
               $number_dcm = "0.{$number_dcm}";

               $this->price = $number + $number_dcm;
               break;
