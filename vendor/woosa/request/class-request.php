...
class Request {
   ...
   public function send($url){
      ...
      if( Util::array($this->args)->get('authorized', true) ){
         ...
         if( ! empty($cached) ){
            ...
            $this->maybe_cache_body($body, $code);
   ...
   */
    ...
    * @return void
    */
   protected function set_response(object $response){
    ...
    * @return string
    */
   protected function set_etag(string $etag){
   ...
   */
   ...
   protected function maybe_cache_body($body, $code){
      ...
      if( 'GET' === $this->args['method'] && Util::array($this->args)->get('cache') == true && in_array($code, [200, 201])){
   ...
   protected function get_cached_body(){
      return 'GET' === $this->args['method'] && Util::array($this->args)->get('cache') == true ? Transient::get("request:cached:{$this->hash}") : '';
   }
