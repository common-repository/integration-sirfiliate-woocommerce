...
class Module_Dependency_Hook implements Interface_Hook{
   ...
   public static function add_in_log_criteria_list($items){
      ...
      $items['max_exec_time'] = [
         'type'    => 'warning',
         'message' => sprintf(__('Your server %s should be at least %s seconds! Please get in touch with your hosting provider to increase that otherwise the plugin might not work properly.', 'integration-sirfiliate-woocommerce'), '<code>max_execution_time</code>', Module_Dependency::max_exec_time()),
         'hook'    => 'admin_init',
