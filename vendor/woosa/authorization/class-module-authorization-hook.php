...
class Module_Authorization_Hook implements Interface_Hook{
   ...
   public static function add_in_log_criteria_list($items){
      ...
      $items['not_authorized'] = [
         'type'    => 'warning',
         'message' => sprintf(__('You have to authorize the plugin. Please go to %sthis page%s.', 'integration-sirfiliate-woocommerce'), '<a href="'.SETTINGS_URL.'&section=authorization">', '</a>'),
         'hook'    => 'admin_init',
